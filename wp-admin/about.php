	...
	<div class="wrap about__container">
			...
			<div class="column is-edge-to-edge">
				...
				<p>
					...
					printf(
						...
						__( 'The Kit&#8209;Two theme is already available to you. It came installed with WordPress 5.9, and you will find it with <a href="%s">your other installed themes</a>.' ),
		...
		<div class="about__section has-2-columns has-gutters is-wider-right">
			<div class="column is-edge-to-edge">
				...
				<p>
					<?php _e( 'More block themes built for full site editing features are in the Theme Directory alongside the Kit&#8209;Two theme, just waiting to be explored. Expect more to come!' ); ?>
				</p>
				<p>
					<?php _e( 'When you use any of those new themes, you no longer need the Customizer. Instead, you have all the power of the Styles interface inside the Site Editor. Just as in Kit&#8209;Two, you build your site&#8217;s look and feel there, with the tools you need for the job in a fluid interface that practically comes alive in your hands.' ); ?>
				</p>
			</div>
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
