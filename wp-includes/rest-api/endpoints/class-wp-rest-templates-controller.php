...
class WP_REST_Templates_Controller extends WP_REST_Controller {
	...
	/**
	 * Requesting this endpoint for a template like 'kittwo//home'
	 * requires using a path like /wp/v2/templates/kittwo//home. There
	 * are special cases when WordPress routing corrects the name to contain
	 * only a single slash like 'kittwo/home'.
	 *
