 ...
 * @return void
 */
function kittwo_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'kittwo' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'kittwo' ) ),
		'header'   => array( 'label' => __( 'Headers', 'kittwo' ) ),
		'query'    => array( 'label' => __( 'Query', 'kittwo' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'kittwo' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'kittwo_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'kittwo_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'kittwo/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'kittwo_register_block_patterns', 9 );
