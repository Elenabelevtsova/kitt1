...
Kit-One is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how Kit-One elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Kit-One in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
Kit-One uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
Kit-One WordPress Theme, 2020-2022 WordPress.org
Kit-One is distributed under the terms of the GNU GPL.
...
Kit-One is derived from Seedlet, (C) 2020 Automattic, Inc.

Kit-One is also based on:
...
Kit. Copyright (C) 2020-2022 WordPress.org
Kit is distributed under the terms of the GNU GPL v2 or later.
